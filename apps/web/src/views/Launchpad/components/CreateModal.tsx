    ...
    await campaignFactory?.createCampaign(
      {
        ...
        start_date: BigNumber.from(Math.floor(parseInt(formValues?.startDate.replaceAll('/', '')) / 1000)),
        end_date: BigNumber.from(Math.floor(parseInt(formValues?.endDate.replaceAll('/', '')) / 1000)),
